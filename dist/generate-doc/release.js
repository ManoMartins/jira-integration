...
function releaseSection(lastSprintsBySquad) {
    return {
        ...
        children: [
            ...
            ...(0, lodash_1.flatMap)(Object.entries((0, lodash_1.groupBy)(lastSprintsBySquad[0].issues, "module")).map(([key, issues]) => {
                const paragraphs = [];
                ...
                Object.entries((0, lodash_1.groupBy)(issues, "parent.key")).forEach(([parentKey, i]) => {
                    paragraphs.push(generateIssueParagraph(parentKey, i[0].parent.summary, 0, {
                        before: 240,
                        after: 120,
                    }));
                    i.forEach((issue) => {
                        paragraphs.push(generateIssueParagraph(issue.key, issue.summary, 1));
                    });
                });
                return paragraphs;
            })),
